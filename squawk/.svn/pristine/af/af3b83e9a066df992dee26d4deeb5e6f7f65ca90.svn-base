...
//        this.typeMap = typeMap;
        ...
        if (false) Assert.that(parametersCount >= 0);
        if (false) Assert.that(maxStack >= 0);
    }
...
//    }
    ...
    void encodeHeader(ByteBufferEncoder enc) {
        ...
        if (false) Assert.that((enc.getSize() - start) == ((localsCount+parametersCount+7)/8));
        if (false) Assert.that(typeTableSize      < 32768);
        if (false) Assert.that(exceptionTableSize < 32768);
        if (false) Assert.that(localsCount        < 32768);
        if (false) Assert.that(parametersCount    < 32768);
        if (false) Assert.that(maxStack           < 32768);
    ...
    private void writeMinfoSize(ByteBufferEncoder enc, int value) {
        if (value < 128) {
            ...
            if (false) Assert.that(value < 32768);
