...
//            }
            ...
            try {
                System.out.println("openning url: " + url);
...
/*end[FLASH_MEMORY]*/
    ...
    protected void connect() throws IOException {
        ...
        try {
            ...
            if (httpProxy != null) {
                streamConnnection = (StreamConnection) Connector.open("socket://" + httpProxy, Connector.READ_WRITE, timeouts);
                proxyReqAdd = protocol + "://" + host + ":" + port + "/";
            } else {
                streamConnnection = (StreamConnection) Connector.open("socket://" + host + ":" + port, Connector.READ_WRITE, timeouts);
            }
