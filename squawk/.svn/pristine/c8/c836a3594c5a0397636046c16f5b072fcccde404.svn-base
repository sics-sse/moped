    ...
    public void close() {
        try {
            synchronized (this) {
                ...
                if (false) Assert.that(mailbox != null, "mailbox is null");
                if (false) Assert.that(otherAddress != null, "otherAddress is null");
                if (false) Assert.that(owner != null, "owner is null");
