...
public abstract class Structure {
    ...
    static class NullStruct extends Structure {
        ...
        public void read() {
            if (Assert.SHOULD_NOT_REACH_HERE_ALWAYS_ENABLED) Assert.shouldNotReachHere("Structure.java", 196);
        }

        public void write() {
            if (Assert.SHOULD_NOT_REACH_HERE_ALWAYS_ENABLED) Assert.shouldNotReachHere("Structure.java", 200);
        }
