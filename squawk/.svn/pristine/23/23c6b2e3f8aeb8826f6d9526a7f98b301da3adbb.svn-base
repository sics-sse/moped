 ...
 * <TD>::= "<strong>datagram://</strong>" | "<strong>datagram://</strong>"&lt;hostport&gt;
 * </TD>
 * </TR>
 * <TR>
 * <TD>&lt;hostport&gt; </TD>
 ...
 * </TABLE>
 *
 * @since MIDP 2.0, Foundation Profile 1.1, Java Card 3.0
 */
public interface UDPDatagramConnection extends DatagramConnection {
     ...
     * the datagram connection from an external system. Since IP addresses may
     * be dynamically assigned, a remote application will need to be robust in
     * the face of IP number reassignment.
     * </P>
     * <P>
