...
public final class HitBreakpoint {
    ...
    HitBreakpoint(VMThread thread, Offset hitFO, Offset hitBCI) {
        ...
        if (false) Assert.that(!hitFO.isZero());
        if (false) Assert.that(getMethod() != null);
    }
    ...
    HitBreakpoint(VMThread thread, Offset throwFO, Offset throwBCI, Throwable exception, Offset catchFO, Offset catchBCI) {
        ...
        if (false) Assert.that(!throwFO.isZero());
        if (false) Assert.that(getMethod() != null);
        if (false) Assert.that(!catchFO.isZero());
        if (false) Assert.that(getCatchMethod() != null);
    }
...
//    }
    ...
    final void setState(int value) {
        if (false) Assert.that(value >= BP_HIT && value <= EXC_REPORTED);
        state = value;
    }
