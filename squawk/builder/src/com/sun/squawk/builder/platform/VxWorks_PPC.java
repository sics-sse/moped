...
/**
 * This class represents VxWorks on a PowerPC processor.
 *
 * @version 1.0
 */
public class VxWorks_PPC extends Unix {

    public VxWorks_PPC(Build env) {
        super(env);
    }
    ...
    public CCompiler createDefaultCCompiler() {
        return new GccVxWorksPPCCompiler(env, this);
    }
