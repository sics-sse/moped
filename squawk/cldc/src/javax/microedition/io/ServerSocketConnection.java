 ...
 * of the device. <code>Connector.open</code> MUST check access for the
 * initial server socket connection and <code>acceptAndOpen</code> MUST check
 * before returning each new <code>SocketConnection</code>.
 * </P>
 * <P>
