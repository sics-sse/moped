 ...
 */
public abstract class ConnectionBaseAdapter extends ConnectionBase implements
    StreamConnection {
...
//    boolean isReadFromBuffer = false;
     ...
     */
    public int available() throws IOException {
//System.err.println("BaseInputStream.available()...");
        ensureOpen();
...
//System.err.println("BaseInputStream.read()...");
        if (read(buf, 0, 1) > 0) {
            return (buf[0] & 0xFF);
        }
...
//System.err.println("BaseInputStream.read, markSupported case");
...
//            }
//        }
//System.err.println("BaseInputStream.read, NOT markSupported case");
