...
public class Platform {
    ...
    public final static boolean IS_BARE_METAL = (BARE_METAL == BARE_METAL);
    public final static boolean IS_DELEGATING = (BARE_METAL == DELEGATING);
    public final static boolean IS_NATIVE = (BARE_METAL == NATIVE);
    public final static boolean IS_SOCKET = (BARE_METAL == SOCKET);
