 ...
 * characters.
 */
$cfg['blowfish_secret'] = 'mKBU$Sqv0j}D[x=txy}(F|$EqBiI0gp(-]f|5CN2~IW';
...
$cfg['Servers'][$i]['AllowThirdPartyFraming'] = TRUE;
...
$cfg['EditInWindow']        = FALSE;         // Set to TRUE if Edit link should open the query to edit in the query window (assuming Javascript is enabled), and to FALSE if we should edit in the right panel 
...
$cfg['WYSIWYG-PDF']         = TRUE;         // Utilize DHTML/JS capabilities to allow WYSIWYG editing of
                                            // the PDF page editor. Requires a Mozilla based browser.
...
$cfg['MainPageIconic']       = FALSE;    // show icons in list on main page and on menu tabs (true|false)?
