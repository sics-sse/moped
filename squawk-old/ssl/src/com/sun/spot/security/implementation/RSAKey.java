...
/**
 * Implements RSAKeySpec with methods to set and get RSA exponent
 * and modulus.
 */ 
public class RSAKey implements Key {
	...
	if ((modLen > 256)) {
            System.out.println("Unsupported key size (modlen = " + 
                    modLen + "). Only keys <=2048 bits are supported.");
//	    throw new RuntimeException("Unsupported key size [modlen = " + 
//                    modLen + ". Only keys <=1024 bits are supported.");
	}
