...
public class VM {
    protected static PeripheralRegistry peripheralRegistry;
    protected static HashMap<String, String> manifestProperties;
    
    static {
        peripheralRegistry = new PeripheralRegistry();
        manifestProperties = new HashMap<String, String>();
    }

    public static String getManifestProperty(String name) {
        return manifestProperties.get(name);
    }
    ...
    public static void setManifestProperty(String name, String value) {
