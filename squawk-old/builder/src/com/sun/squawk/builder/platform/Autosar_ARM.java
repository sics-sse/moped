...
/**
 * This class represents Linux on an arm processor.
 */
public class Autosar_ARM extends Unix {

    public Autosar_ARM(Build env) {
        super(env);
    }
    ...
    public File getToolsDir() {
        return new File("tools", "autosar-arm");
    }
    ...
    public CCompiler createDefaultCCompiler() {
        return new GccAutosarCompiler(env, this);
    }
