...
{
	{
		...
		.DMA_CHANNEL_PREEMPTION_ENABLE = BIT(1)		// Sets the value of the ENABLE register (enabling dma engine 0)
	},

	{
		.DMA_CHANNEL_PRIORITY = DMA_CHANNEL1,
		.DMA_CHANNEL_PREEMPTION_ENABLE = BIT(2)		// Sets the value of the ENABLE register (enabling dma engine 1)
	},
};
