...
#define PDUR_PDU_ID_ACKNOWLEDGEMENTSCUPDU  CANIF_PDU_ID_ACKNOWLEDGEMENTSCUPDU
#define PDUR_REVERSE_PDU_ID_ACKNOWLEDGEMENTSCUPDU	COM_PDU_ID_ACKNOWLEDGEMENTSCUPDU
