...
$GLOBALS['cfg']['NaviBackground']           = '#D6DDE5';
 ...
 */
$GLOBALS['cfg']['FontFamily']           = 'Tahoma, Geneva, sans-serif';
/**
 * fixed width font family, used in textarea
 */
$GLOBALS['cfg']['FontFamilyFixed']      = '"Lucida Console", Monaco, monospace';
...
$GLOBALS['cfg']['ThBackground']         = '#D6DDE5';
