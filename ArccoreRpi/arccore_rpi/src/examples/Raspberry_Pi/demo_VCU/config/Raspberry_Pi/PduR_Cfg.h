...
#define PDUR_PDU_ID_ACKNOWLEDGEMENTVCUPDU  CANIF_PDU_ID_ACKNOWLEDGEMENTVCUPDU
#define PDUR_REVERSE_PDU_ID_ACKNOWLEDGEMENTVCUPDU	COM_PDU_ID_ACKNOWLEDGEMENTVCUPDU
			
#define PDUR_PDU_ID_PLUGINCOMMUNICATIONTCUTOVCUPDU  COM_PDU_ID_PLUGINCOMMUNICATIONTCUTOVCUPDU
#define PDUR_REVERSE_PDU_ID_PLUGINCOMMUNICATIONTCUTOVCUPDU	CANIF_PDU_ID_PLUGINCOMMUNICATIONTCUTOVCUPDU
			
#define PDUR_PDU_ID_PLUGINCOMMUNICATIONVCUTOTCUPDU  CANIF_PDU_ID_PLUGINCOMMUNICATIONVCUTOTCUPDU
#define PDUR_REVERSE_PDU_ID_PLUGINCOMMUNICATIONVCUTOTCUPDU	COM_PDU_ID_PLUGINCOMMUNICATIONVCUTOTCUPDU
			
#define PDUR_PDU_ID_PLUGININSTALLATIONVCUPDU  COM_PDU_ID_PLUGININSTALLATIONVCUPDU
#define PDUR_REVERSE_PDU_ID_PLUGININSTALLATIONVCUPDU	CANIF_PDU_ID_PLUGININSTALLATIONVCUPDU
			
#define PDUR_PDU_ID_DRIVERSETSPEEDSTEERINGPDU  COM_PDU_ID_DRIVERSETSPEEDSTEERINGPDU
#define PDUR_REVERSE_PDU_ID_DRIVERSETSPEEDSTEERINGPDU	CANIF_PDU_ID_DRIVERSETSPEEDSTEERINGPDU
			
#define PDUR_PDU_ID_PLUGINCOMMUNICATIONVCUTOSCUPDU  CANIF_PDU_ID_PLUGINCOMMUNICATIONVCUTOSCUPDU
#define PDUR_REVERSE_PDU_ID_PLUGINCOMMUNICATIONVCUTOSCUPDU	COM_PDU_ID_PLUGINCOMMUNICATIONVCUTOSCUPDU
			
#define PDUR_PDU_ID_PLUGINCOMMUNICATIONSCUTOVCUPDU  COM_PDU_ID_PLUGINCOMMUNICATIONSCUTOVCUPDU
#define PDUR_REVERSE_PDU_ID_PLUGINCOMMUNICATIONSCUTOVCUPDU	CANIF_PDU_ID_PLUGINCOMMUNICATIONSCUTOVCUPDU
			
#define PDUR_PDU_ID_POISTIONDATAPDU  COM_PDU_ID_POISTIONDATAPDU
#define PDUR_REVERSE_PDU_ID_POISTIONDATAPDU	CANIF_PDU_ID_POISTIONDATAPDU
